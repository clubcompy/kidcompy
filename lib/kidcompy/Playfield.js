...
Playfield.prototype.generateCharacterMap = function(characterCode, inverted) {
  ...
  var kidsciiCharacter = Playfield.kidsciiCharacterData["" + characterCode];

  if(kidsciiCharacter) {
    var rowData = inverted ? kidsciiCharacter.invertedCharMap : kidsciiCharacter.charMap,
      format = kidsciiCharacter.nybbleCount === 2 ? CharacterMap.Format.W8H8B1 : CharacterMap.Format.W16H16B1;
 ...
 */
Playfield.reserveCharacterMapSlots = function(characterMapsList, characterCode) {
  var i;
