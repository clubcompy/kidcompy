...
LifecycleEvents.prototype.initLifecycleEvents = function() {
  ...
  if(document.addEventListener) { // Mozilla, Opera, Webkit
    XHConn2.addOneShotEventListener(document, "DOMContentLoaded", self.triggerOnReady);
  }
  else if(document.attachEvent) { // If IE event model is used
    XHConn2.addOneShotEventListener(document, "readystatechange", self.triggerOnReady);
  }
  ...
  XHConn2.addOneShotEventListener(window, "load", self.triggerOnLoad);
};
