 ...
 */
function DomMutationsLog(logEnabled) {
  /**
 ...
 */
DomMutationsLog.prototype.positionChild = function(parentNode, childNode, top, left) {
  DomTools.setInlineStyles(childNode, {
    top: top + "px",
    left: left + "px"
  });
 ...
 */
DomMutationsLog.prototype.logAppendChildEvent = function(parentNode, childNode) {
 ...
 * @param {!number} left assumes integer
 */
DomMutationsLog.prototype.logPositionChildEvent = function(parentNode, childNode, top, left) {
