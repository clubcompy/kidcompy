...
/**
 * Other little useful functions
 *
 * @package
 */
MandatoryGlobals.prototype.installOtherKnicknacks = function() {
  kidcompy.noop = function() {};
  kidcompy.identity = function(x) {
    return x;
  };
};
