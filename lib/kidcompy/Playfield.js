...
function Playfield(flipBuffer, nodeCache, ordinal, isLast, ownerDocument, systemProperties, mutationsLog) {
   ...
   * @type {kidcompy.ScrollableCanvasBase}
   */
  self.scrollableCanvas = kidcompy.createScrollableCanvas(playfieldDiv, self.systemProperties, mutationsLog);
...
Playfield.prototype.fillRectangle = function(left, top, width, height, fillStyle) {
  ...
  self.scrollableCanvas["fillRectangle"](playfieldDiv, left, top, width, height, fillStyle);
};
...
Playfield.prototype.pan = function(offsetX, offsetY, domMutationsLog) {
  ...
  self.scrollableCanvas["pan"](playfieldDiv, offsetX, offsetY, domMutationsLog);
};
...
Object.assign(Playfield, /** @lends {Playfield} */ {
  ...
  createCanvases: function(playfieldDiv, systemProperties, domMutationsLog) {
    ...
    DomTools.setInlineStyles(playfieldDiv, {
      width: widthPx,
      height: heightPx
    });
