...
describe("Playfield.spec >", function() {
  ...
  describe("init >", function() {
    ...
    it("will set the nodeId in the created div", function() {
      ...
      proclaim.isNotNull(canvas0, "canvas 0 was found in the clipDiv subtree");
      proclaim.equal("CANVAS", canvas0.tagName, "Child is a canvas tag");

      canvas1 = DomTools.findChildByClass(clipDiv, "c1");
      proclaim.isNotNull(canvas1, "canvas 1 was found in the clipDiv subtree");
      proclaim.equal("CANVAS", canvas1.tagName, "Child is a canvas tag");

      canvas2 = DomTools.findChildByClass(clipDiv, "c2");
      proclaim.isNotNull(canvas2, "canvas 2 was found in the clipDiv subtree");
      proclaim.equal("CANVAS", canvas2.tagName, "Child is a canvas tag");

      canvas3 = DomTools.findChildByClass(clipDiv, "c3");
      proclaim.isNotNull(canvas3, "canvas 3 was found in the clipDiv subtree");
      proclaim.equal("CANVAS", canvas3.tagName, "Child is a canvas tag");
    });
