  ...
  if(!PRODUCTION_MODE) {
    ...
    installWebpackHotReloadScript = function() {
      ...
      function setupCanvasFactory() {
         ...
         */
        function createHtml5ScrollableCanvas(playfieldDiv, systemProperties, domMutationsLog) {
          return new Html5ScrollableCanvas(playfieldDiv, systemProperties, domMutationsLog);
        }

        // override and update the global createScrollableCanvas function
        kidcompy.createScrollableCanvas = kidcompy.createScrollableCanvas || createHtml5ScrollableCanvas;
