...
function Playfield(flipBuffer, nodeCache, ordinal, systemProperties, mutationsLog) {
  ...
  DomNodeSurrogate.call(self, flipBuffer, "p" + ordinal, DomNodeType.PLAYFIELD, nodeCache);
  ...
  flipBufferDiv = nodeCache.findDomNode(flipBuffer);
 ...
 */
Playfield.prototype.pan = function(offsetX, offsetY, systemProperties, domMutationsLog) {
  // jshint -W016
  ...
  playfieldDiv = this.nodeCache.findDomNode(this);
