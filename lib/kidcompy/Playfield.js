 ...
 */
Playfield.prototype.createCanvases = function(playfieldDiv, domMutationsLog) {
  var i, canvas;
  ...
  for(i = 0; i < 4; i++) {
    ...
    // Canvas: I'm expecting my dimensions to be set here!!
...
Playfield.prototype.getCanvasWidth = function() {
  var parentFlipBuffer = /** @type {FlipBuffer} */ this.parent,
    gpKidcompyHost = /** @type {KidcompyHost} */ parentFlipBuffer.parent;

  return gpKidcompyHost.displayWidth;
};
...
Playfield.prototype.getCanvasHeight = function() {
  ...
  return gpKidcompyHost.displayHeight;
};
