...
describe("KidcompyHost > ", function() {
  ...
  describe("constructor > ", function() {
    it("pulls the id out of theDiv", function() {
      ...
      var kidcompyHost = new KidcompyHost(theDiv);
    ...
    it("adds FlipBuffers to theDiv", function() {
      ...
      var domMutations = new DomMutationsLog(),
      ...
      proclaim.isNotNull(domMutations.findEntryByClassName(DomMutationsLog.EventType.APPEND_CHILD, "f0"));
      proclaim.isNotNull(domMutations.findEntryByClassName(DomMutationsLog.EventType.APPEND_CHILD, "f1"));
    });
  ...
  describe("attachFlipBuffers (static) > ", function() {
    it("constructs two FlipBuffers with expected attributes", function() {
      var flipBuffers = KidcompyHost.attachFlipBuffers(theDiv, new DomMutationsLog());
