...
describe("FlipBuffer.spec", function() {
  ...
  describe("init", function() {
    it("should add its div to the Host's div", sinon.test(function() {
      ...
      var flipBuffer = new FlipBuffer({nodeType: DomNodeType.KIDCOMPY_HOST}, rootDiv, 0, new SystemProperties(), new DomMutationsLog());
    ...
    it("must add 8 Playfields to the FlipBuffer", function() {
      var flipBuffer = new FlipBuffer({nodeType: DomNodeType.KIDCOMPY_HOST}, rootDiv, 1, new SystemProperties(), new DomMutationsLog());
