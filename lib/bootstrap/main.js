 ...
 * @package
 */
Main.setupConsoleFunctions = function() {
  ...
  // just be super-duper sure and set console and its functions to something innocuous if there is anything amiss
  if(!window["console"]) {
    window["console"] = {};
  }
  if(!console["log"]) {
