...
// all kidcompy code starts executing here
...
// Immediately polyfill any built-in object functions that frameworks we depend on like Webpack will call.
// This should tide us over until we load iePolyfill and html5Polyfill which can do a more complete job of filling
// the gaps
...
/* Inject stylesheets dynamically.  IE6 madness: you can't inject a link tag safely unless the injecting function is
 called from the window context??  (That's what the setTimeout() is doing here, escapes us from scripty-loady context?)
