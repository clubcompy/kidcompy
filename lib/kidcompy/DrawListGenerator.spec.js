...
describe("DrawListGenerator.spec", function() {
  ...
  describe("rectanglesFrom8x8", function() {
    it("will return an empty array for a clear character bitmap", function() {
      ...
      expect.equals("", filledRectangles, "All clear bits should make an empty array");
    });
    ...
    it("will return a single rectangle array covering the whole character for all pixels filled", function() {
      ...
      expect.equals(makeU16String(0, 0, 16, 16), filledRectangles, "One 8x8 rectangle representing the filled char");
    });
    ...
    it("will return two rectangle array covering a checkerboard pattern of filled pixels", function() {
      ...
      expect.equals(
        makeU16String(0, 0, 8, 8) + // rectangle #0 fills upper-left 4x4 square, times 2
        makeU16String(8, 8, 8, 8), // rectangle #1 fills lower-right 4x4 square, times 2
        filledRectangles,
    ...
    it("will return three rectangle array covering a cross pattern of filled pixels", function() {
      ...
      expect.equals(
        makeU16String(6, 0, 4, 16) + // rectangle #0 is a tall, thin rectangle in the center of the bitmap, 2x8, times 2
        makeU16String(0, 6, 6, 4) + // rectangle #1 is the left of the horizontal bar, times 2
        makeU16String(10, 6, 6, 4), // rectangle #2 is the right of the horizontal bar, times 2
        filledRectangles,
