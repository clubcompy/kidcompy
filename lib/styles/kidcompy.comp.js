...
describe("kidcompy.comp", function() {
  ...
  beforeEach(function() {
    ...
    flipBufferTag = frame.add("<div id='kidcompyHost'></div>", "kidcompy DOM tree");
    kidcompyHost = new KidcompyHost("kidcompyHost", flipBufferTag.toDomElement().ownerDocument);
  });
  ...
  describe("flipbuffers under kidcompyHost", function() {
    it("aligns all flipbuffers with the top-left of the kidcompyHost", function() {
      ...
      flipBuffer1.assert({top: flipBuffer0.top, left: flipBuffer0.left}, "FlipBuffer #0 is overlapping FlipBuffer #1");
    });
  });
