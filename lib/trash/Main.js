...
var Dependency = require("./Dependency"),
  buildInfo = require("./../kidcompy/buildInfo");
...
Main.prototype = {
  ...
  /**
   * Get build info on this release of KidCompy
   *
   * @returns {BuildInfo}
   */
...
setInterval(function() {
  ...
  document.getElementById("test").innerHTML += JSON.stringify(main.getBuildInfo(), null, " ");

  document.getElementById("test").innerHTML += main.f() + "<br />";
}, 1000);
