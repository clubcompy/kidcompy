 ...
 *
 * <p>Do not require() this module directly, it will be imported for you automatically by the build scripts as the
 * symbol named 'featureFlags'
 *
 ...
 *           map, then the Boolean value will override the value in FeatureFlagData[1].  Use this map to do feature
 *           development that other developers will not see in their builds.
 */
