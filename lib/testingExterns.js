 ...
 * @returns {(Function|spyApi)} proxy to thingToBeSpiedUpon plus spyApi additional mixins
 */
sinon.spy = function(objectToBeSpiedUpon, nameOfFunction) {
  return function() {};
};
 ...
 * @param {string=} msg
 */
proclaim.notThrows = function(ftn, expected, msg) {};
