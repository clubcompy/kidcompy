...
describe("DomMutationsLog >", function() {
  ...
  describe("logAppendChildEvent >", function() {
    it("will track parent-child relationships", function() {
      ...
      // this line is failing in production builds, figure out why and earn a cookie
      kidcompy.log("log entry event type = " + mutationLogEntry.eventType);
      kidcompy.log("APPEND_CHILD = " + DomEventType.APPEND_CHILD);
