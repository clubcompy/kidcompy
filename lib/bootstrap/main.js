...
// exist at startup.  Later, we should do some more intelligent shimming of the console for legacy IE?
if(!window.console) {
  window.console = {};
  ...
  if(!console.groupCollapsed) {
    /** Dummy groupCollapsed function */
    console.groupCollapsed = function() {};
  }

  if(!console.groupEnd) {
    /** Dummy groupEnd function */
...
// do a global export of the ScrollableCanvasBase class and make a dummy factory function
kidcompy.ScrollableCanvasBase = require("./ScrollableCanvasBase");

/**
 * Factory function for creating a scrollable canvas
 */
kidcompy.createScrollableCanvas = null;

// export the ScrollableCanvasBase class and no-op createScrollableCanvas to the kidcompy namespace
exportPublicProperties(kidcompy, [
  [ "ScrollableCanvasBase", kidcompy.ScrollableCanvasBase ],
