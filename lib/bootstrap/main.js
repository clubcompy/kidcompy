...
// create the global kidcompy namespace before anything else ...
require("./kidcompyNamespace");

// import the extend function into the kidcompy namespace
require("../symbols/extend");

var XHConn2 = require("./XHConn2"),
  detectIePolyfill = require("./detectIePolyfill"),
...
Main.SCRIPT_BASE_URI = (function() {
  var scripts = document.getElementsByTagName("script"),
    ...
    bootstrapScriptUri = URI(bootstrapScriptTag.getAttribute("src"));

  return URI({
    protocol: bootstrapScriptUri.protocol(),
    authority: bootstrapScriptUri.authority(),
    directory: bootstrapScriptUri.directory()
  });
})();
...
Main.prototype.loadScriptsAsync = function() {
  ...
  if(PRODUCTION_MODE) {
    ...
    self.initializeIePolyfills(function() {
      self.initializeHtml5Polyfills(function() {
        self.initialize(function() {
          self.triggerOnCodeGo();
        });
      });
    });
  }
...
Main.prototype.completeOnScript = function() {
  ...
  if(self.iePolyfillXhr) {
    ...
    self.initializeIePolyfills(self.completeIePolyfillInit);
  }
...
Main.prototype.processHtml5Polyfills = function() {
  ...
  self.detectHtml5Polyfill.check(function(html5PolyfillsRequired) {
