...
describe("Playfield.spec >", function() {
  ...
  describe("init >", function() {
    ...
    it("will throw if second parameter is not an Element is not passed for 1th parameter", function() {
      proclaim.throws(function() {
        // the first object passed to playfield is expected to have "nodeType: DomNodeType.FLIPBUFFER" on as a member
        // the following will throw
        playfield = new Playfield({nodeType: DomNodeType.PLAYFIELD}, "Not a DOM Element", 0, systemProperties, domMutationsLog);
    ...
    it("will validate required parameters", function() {
      ...
      playfield = new Playfield({nodeType: DomNodeType.FLIPBUFFER}, document.createElement("div"), 1, systemProperties,
        domMutationsLog);
    ...
    it("will set the nodeId in the created div", function() {
      ...
      playfield = new Playfield({nodeType: DomNodeType.FLIPBUFFER}, parentFlipBufferDiv, 1, systemProperties, domMutationsLog);
      ...
      proclaim.equal(playfieldDiv, logEntry.data.parentNode, "Canvas was attached as a child to PF's div");
  ...
  describe("getCanvasWidth and getCanvasHeight >", function() {
    ...
    beforeEach(function() {
      ...
      playfield = new Playfield({ nodeType: DomNodeType.FLIPBUFFER },
  ...
  describe("layoutCanvases >", function() {
    ...
    it("will layout the canvases in the default positions", function() {
      ...
      Playfield.positionCanvases(0, 0, 0, playfieldDiv, systemProperties, domMutationsLog);
    ...
    it("will layout the canvases in a wacky scrolled position", function() {
      ...
      Playfield.positionCanvases(-10, -20, 3, playfieldDiv, systemProperties, domMutationsLog);
  ...
  describe("fillRectangle() and scroll()", function() {
    ...
    beforeEach(function() {
      ...
      playfield = new Playfield({ nodeType: DomNodeType.FLIPBUFFER }, parentDiv, 0, systemProperties, domMutationsLog);
    ...
    it("will fill pixels across the canvas", function() {
      playfield.fillRectangle(playfieldDiv, 2, 2, 2, 2, "#ff00ff");
    ...
    it("will pan the logical canvas and fill pixels that span the actual canvases", function() {
      playfield.pan(playfieldDiv, -3, -3, systemProperties, domMutationsLog);
