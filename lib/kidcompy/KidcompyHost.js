...
function KidcompyHost(theDiv, mutationsLog) {
  ...
  /**
   * @name KidompyHost#systemProperties
...
KidcompyHost.prototype.attachFlipBuffers = function(theDiv, mutationsLog) {
  ...
  return [
    new FlipBuffer(self, theDiv, 0, self.systemProperties, mutationsLog),
    new FlipBuffer(self, theDiv, 1, self.systemProperties, mutationsLog)
  ];
};
