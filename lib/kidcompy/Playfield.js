...
function Playfield(flipBuffer, flipBufferDiv, ordinal, systemProperties, mutationsLog) {
  ...
  /**
   * The owning {@link FlipBuffer} for this Playfield
   *
   * <p>This object may not be used other than for debugging purposes.
   *
...
Playfield.prototype.fillRectangle = function(playfieldDiv, left, top, width, height, fillStyle) {
  ...
  canvasContexts[this.topLeftCanvas].fillRect(left - this.canvasPositionX, top - this.canvasPositionY, width, height);
  canvasContexts[this.topLeftCanvas ^ 1].fillStyle = fillStyle;
  canvasContexts[this.topLeftCanvas ^ 1].fillRect(left - this.canvasPositionX - this.getCanvasWidth(), top - this.canvasPositionY, width, height);
  canvasContexts[this.topLeftCanvas ^ 2].fillStyle = fillStyle;
  canvasContexts[this.topLeftCanvas ^ 2].fillRect(left - this.canvasPositionX, top - this.canvasPositionY - this.getCanvasHeight(), width, height);
  canvasContexts[this.topLeftCanvas ^ 3].fillStyle = fillStyle;
  canvasContexts[this.topLeftCanvas ^ 3].fillRect(left - this.canvasPositionX - this.getCanvasWidth(), top - this.canvasPositionY - this.getCanvasHeight(), width, height);
};
