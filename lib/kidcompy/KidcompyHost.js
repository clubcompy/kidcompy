 ...
 * @param {!Document} ownerDocument The DOM Document that this KidcompyHost belongs to
...
Object.assign(KidcompyHost, /** @lends {KidcompyHost} */ {
  ...
  attachFlipBuffers: function(kidcompyHost, nodeCache, systemProperties, mutationsLog) {
    return [
      new FlipBuffer(kidcompyHost, nodeCache, 0, kidcompyHost.ownerDocument, systemProperties, mutationsLog),
      new FlipBuffer(kidcompyHost, nodeCache, 1, kidcompyHost.ownerDocument, systemProperties, mutationsLog)
    ];
  }
});
