...
describe("FlipBuffer.spec >", function() {
  ...
  describe("constructor >", function() {
    it("should add its div to the Host's div", function() {
      ...
      var flipBuffer = new FlipBuffer(rootDiv, 0, new DomMutationsLog());
    ...
    it("must add 8 Playfields to the FlipBuffer", function() {
      var flipBuffer = new FlipBuffer(rootDiv, 1, new DomMutationsLog());
      ...
      for(var i = 0, ii = 8; i < ii; i++) {
        ...
        proclaim.equal("p" + i, flipBuffer.playfields[i].id, "ID's are correct");
      }
    });
