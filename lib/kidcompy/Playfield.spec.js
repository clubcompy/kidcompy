...
describe("Playfield.spec", function() {
  ...
  describe("createCanvases", function() {
    ...
    beforeEach(function() {
      ...
      playfield = new Playfield({isFlipBuffer: true}, document.createElement("div"), 1, throwawayLog);
    });

    it("will create four canvases", function() {
      var playfieldDiv = document.createElement("div"),
        domMutationsLog = new DomMutationsLog(true);

      playfield.createCanvases(playfieldDiv, domMutationsLog);
  ...
  describe("getCanvasWidth and getCanvasHeight", function() {
    ...
    beforeEach(function() {
      ...
      // REFACTOR MEEE!!!
      playfield = new Playfield({isFlipBuffer: true, parent: { displayWidth: 320, displayHeight: 240 }},
        document.createElement("div"), 1, throwawayLog);
    });

    it("must return constants from constants.js", function() {
      proclaim.equal(320, playfield.getCanvasWidth(), "width comes from constants.js by way of KidcompyHost, for now");
      proclaim.equal(240, playfield.getCanvasHeight(), "height comes from constants.js from KidcompyHost, for now");
    });
  });
});
