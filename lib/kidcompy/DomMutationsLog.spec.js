...
describe("DomMutationsLog >", function() {
  ...
  describe("logAppendChildEvent >", function() {
    it("will create track parent-child relationships", function() {
      ...
      proclaim.equal(DomMutationsLog.EventType.APPEND_CHILD, mutationLogEntry.eventType, "logged the right type");
  ...
  describe("findEntryByClassName >", function() {
    it("will find an entry whose classname contains a match", function() {
      ...
      mutationEntry = domMutations.findEntryByClassName(DomMutationsLog.EventType.APPEND_CHILD, "findMe");
      ...
      mutationEntry = domMutations.findEntryByClassName(DomMutationsLog.EventType.APPEND_CHILD, "ImNotThere");
