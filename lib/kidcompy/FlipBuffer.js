 ...
 * @param {!DomNodeCache} nodeCache cache that will be used to find/update DOM Nodes
...
/**
 * As a layer, move this flipbuffer to the foreground relative to other flipBuffers
 */
FlipBuffer.prototype.flipToForeground = function() {
  var self = this,
    flipBufferDiv;

  flipBufferDiv = self.nodeCache.findDomNode(self);
  DomTools.addClass(flipBufferDiv, "inForeground");
};

/**
 * As a layer, move this flipbuffer to the background relative to other flipBuffers
 */
FlipBuffer.prototype.flipToBackground = function() {
  var self = this,
    flipBufferDiv;

  flipBufferDiv = self.nodeCache.findDomNode(self);
  DomTools.removeClass(flipBufferDiv, "inForeground");
};
